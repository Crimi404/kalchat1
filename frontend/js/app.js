...
function badgeHtml(badge) {
  if (badge === 'gold') return '<span class="badge badge-gold" title="Admin">👑</span>';
  if (badge === 'diamond') return '<span class="badge badge-diamond" title="VIP">💎</span>';
  if (badge === 'blue') return '<span class="badge badge-check" title="Vérifié">✔️</span>';
  return '';
}
