...
function showMainView(view, profileUsername) {
  ...
  setBottomNavActive(view === 'messages' ? 'messages' : view === 'profil' ? 'profil' : view === 'explorer' ? 'explorer' : 'accueil');
}
...
function renderPostCard(p) {
  ...
  card.innerHTML = `
    <div class="story-card-header">
      ...
      <div>
        <div class="who" style="cursor:pointer;">${p.username === me.username ? 'Vous' : p.username}</div>
